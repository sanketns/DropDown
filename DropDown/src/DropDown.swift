...
extension DropDown {
    ...
    fileprivate func computeLayout() -> (x: CGFloat, y: CGFloat, width: CGFloat, offscreenHeight: CGFloat, visibleHeight: CGFloat, canBeDisplayed: Bool, Direction: Direction) {
        ...
        let heightMin = isCellHeight == true ? 0 : 0
        return (layout.x, layout.y, layout.width, layout.offscreenHeight, visibleHeight - CGFloat(heightMin), canBeDisplayed, direction)
    }
